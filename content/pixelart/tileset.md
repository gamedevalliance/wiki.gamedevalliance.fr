...
{{< figure src="/images/pixelart/tileset/herbe1.png" caption="Un simple carré vert avec des points plus clairs." >}}
<p>
{{< figure src="/images/pixelart/tileset/herbe2.png" caption="Le même carré avec des lignes plus larges et quelques-unes plus sombres pour la profondeur." >}}
<p>
{{< figure src="/images/pixelart/tileset/herbe3.png" caption="Trois teintes pulvérisées alétoirement, puis une sélection 16×16." >}}
<p>
{{< figure src="/images/pixelart/tileset/herbe4.png" caption="Accumulation de brins avec les trois teintes pour obtenir un effet de direction." >}}
...
{{< figure src="/images/pixelart/tileset/herbe2.png" caption="Ok, j'ai mon tile d'herbe…" >}}
<p>
{{< figure src="/images/pixelart/tileset/terre.png" caption="Et maintenant c'est un tile de terre !" >}}
<p>
{{< figure src="/images/pixelart/tileset/eau.png" caption="Et de l'eau ! Ha ha ha !" >}}
<p>
{{< figure src="/images/pixelart/tileset/sable.png" caption="Et voilà le désert ! Je suis un GÉNIE !" >}}

![](/images/pixelart/tileset/mauvaiseidee.png)
...
![](/images/pixelart/tileset/mauvaiseidee2.png)
...
{{< figure src="/images/pixelart/tileset/alberodyssey.png" caption="Alber Odyssey" >}}
<p>
{{< figure src="/images/pixelart/tileset/finalfantasy3.png" caption="Final Fantasy 3" >}}
...
![](/images/pixelart/tileset/herberepetitions.png)
...
{{< figure src="/images/pixelart/tileset/montagnecontour.png" caption="Ok, j'ai dessiné le contour de ma montagne…" >}}
<p>
{{< figure src="/images/pixelart/tileset/montagnedegrade.png" caption="Remplissage dégradé… et j'ai fini ! C'est tellement réaliste !" >}}
...
{{< figure src="/images/pixelart/tileset/triodegrade.png" caption="Trois éléments remplis avec l'outil dégradé." >}}
...
![](/images/pixelart/tileset/triotexture.png)
...
{{< figure src="/images/pixelart/tileset/cabanedegrade.png" caption="Cabane forestière avec des tiles en dégradé." >}}

Maintenant reprenons la même map avec des textures faites à la main.

![](/images/pixelart/tileset/cabanetexture.png)
...
![](/images/pixelart/tileset/mur.png)
...
{{< figure src="/images/pixelart/tileset/murvariations.png" caption="Le tile de brique et ses trois variations." >}}
...
![](/images/pixelart/tileset/finalfantasy1.png)
...
![](/images/pixelart/tileset/finalfantasy1tiles.png)
...
![](/images/pixelart/tileset/dithering.png)
...
![](/images/pixelart/tileset/ditheringbriques.png)
...
![](/images/pixelart/tileset/crystalis.png)
...
![](/images/pixelart/tileset/solcave.png)
...
![](/images/pixelart/tileset/solcave2.png)
...
![](/images/pixelart/tileset/solcave3.png)
...
![](/images/pixelart/tileset/gameboy.png)
...
![](/images/pixelart/tileset/gameboy2.png)
