...
{{< figure src="/images/faq/tileset.png" alt="Changement de tileset" caption="Changement de tileset dans les propriétés de la carte." >}}
...
{{< figure src="../images/faq/teleportation.png" alt="Evènements rapides" caption="Création d'un évènement rapide sur la carte." >}}
...
{{< figure src="../images/faq/automatique.png" alt="Choix du mode de déclenchement d'un évènement" caption="Choix du mode de déclenchement d'un évènement." >}}
...
{{< figure src="../images/faq/page2.png" caption="Création de la deuxième page vide." >}}
