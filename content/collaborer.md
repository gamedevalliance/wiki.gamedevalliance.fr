...
![Fetch origin](/images/collaborer/fetchorigin.png)
...
![Discard file changes](/images/collaborer/discardchanges.png)
...
![Push origin](/images/collaborer/pushorigin.png)
...
![Historique des commits](/images/collaborer/historique.png)

## Gérer les données de RPG Maker

{{< figure class="align-right" src="/images/collaborer/data.png" alt="Liste des fichiers dans le dossier Data" caption="Dossier Data sur VX Ace." >}}
...
{{< figure src="/images/collaborer/mapinfos.png" alt="Liste des cartes du projet" caption="L'arborescence des cartes est enregistrée dans MapInfos." >}}
