...
![Contrôler les variables](/rpgmaker/tutoriels/teleportation/variables.png)

![Données jeu](/rpgmaker/tutoriels/teleportation/donneesjeuX.png)
...
![Données jeu](/rpgmaker/tutoriels/teleportation/donneesjeuID.png)

Votre évènement doit maintenant ressembler à ça :

![Evènement commun](/rpgmaker/tutoriels/teleportation/eventcommun.png)

Vous pouvez vérifier que ça fonctionne ! Dans le jeu, activez l'interrupteur `Système de téléportation` puis appuyez sur F9.

![Debugger](/rpgmaker/tutoriels/teleportation/F9.png)
...
![Si map = 1 et X = 16](/rpgmaker/tutoriels/teleportation/conditionsimbriquees.png)
...
![Transférer joueur](/rpgmaker/tutoriels/teleportation/teleportation.png)
...
![Commandes pour transfert](/rpgmaker/tutoriels/teleportation/partie1.png)
...
![Condition entière](/rpgmaker/tutoriels/teleportation/partie2.png)
