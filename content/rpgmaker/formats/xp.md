...
A partir de [RPG Maker XP]({{< ref "/rpgmaker/serie.md#rpg-maker-xp" >}}) et jusqu'à [VX Ace]({{< ref "/rpgmaker/serie.md#rpg-maker-vx-ace" >}}), les tiles font 32 pixels de côté. Sur RPG Maker XP, un tileset est composé de 7 autotiles disposés en haut, chacun étant stocké dans une image indépendante, puis d'une grande image contenant tous les tiles normaux, de largeur fixe mais de hauteur libre.
