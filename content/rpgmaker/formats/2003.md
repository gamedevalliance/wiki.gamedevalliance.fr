...
Les tilesets de [RPG Maker 2000]({{< ref "/rpgmaker/serie.md#rpg-maker-2000" >}}) et [RPG Maker 2003]({{< ref "/rpgmaker/serie.md#rpg-maker-2003" >}}) sont au même format, et donc interchangeables. Les tiles font 16 pixels de côté. Un tileset tient dans une seule image, qui doit respecter un agencement précis :
